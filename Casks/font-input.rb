cask 'font-input' do
  ...
  url 'http://input.fontbureau.com/build/?fontSelection=whole&a=0&g=0&i=serif&l=serif&zero=slash&asterisk=height&braces=straight&preset=default&line-height=1.2&accept=I+do'
  name 'Input'
